...
function createServer() {
    ...
    expressApp.post('/compress', upload.single('image'), async (req, res) => {
        try {
            if (!req.file) {
    ...
    expressApp.get('/status/:jobId', (req, res) => {
    ...
    expressApp.get('/download/:jobId', (req, res) => {
        const jobId = parseInt(req.params.jobId);
        const job = imageQueue.getJob(jobId);
    ...
    expressApp.get('/download-all', (req, res) => {
    ...
    expressApp.get('/queue-stats', async (req, res) => {
        try {
...
function createWindow() {
    ...
    // Warte bis Server läuft, dann lade die Seite
